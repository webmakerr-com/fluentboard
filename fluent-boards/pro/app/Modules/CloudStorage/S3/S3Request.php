    ...
    public function getResponse()
    {
        ...
        if (S3::hasAuth()) {
            ...
            if ($this->headers['Host'] == 'cloudfront.amazonaws.com') {
                ...
                /*
                 * Digital Ocean uses a different authorization header
                 */
                if (strpos($this->endpoint, 'digitaloceanspaces') !== false) {
                    $authorizationHeader = S3::__getSignatureV4(
                        $this->amzHeaders,
                    ...
                    $httpHeaders = array_unique(array_merge($httpHeaders, [
                        'x-amz-date: ' . $this->amzHeaders['x-amz-date'],
                        'x-amz-content-sha256: ' . $this->amzHeaders['x-amz-content-sha256'],
                        'Host: ' . $this->headers['Host'],
